...
export default function RisksEdit({ risk, cycle, categories }: Props) {
    ...
    const { data, setData, put, processing, errors } = useForm<FormData>({
        ...
        inherent_likelihood:  risk.inherent_likelihood !== null ? String(risk.inherent_likelihood) : '',
        inherent_impact:      risk.inherent_impact !== null ? String(risk.inherent_impact) : '',
        mitigation_summary:   risk.mitigation_summary ?? '',
        residual_likelihood:  risk.residual_likelihood !== null ? String(risk.residual_likelihood) : '',
